# -*- coding: utf-8 -*-
#
# libscientific documentation build configuration file, created by
...
htmlhelp_basename = 'libscientificdoc'
...
latex_documents = [
  ('index', 'libscientific.tex', u'libscientific Documentation',
   u'Giuseppe Marco Randazzo', 'manual'),
]
